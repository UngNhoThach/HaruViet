...
//   DateTime? selected,
//   String? title,
//   int? setMinuteInterval,
//   required void Function(int hours, int minutes) callback,
// }) async {
//   context.hideKeyboard();
//   final now = DateTime.now();
//   var duration = selected != null
//       ? Duration(hours: selected.hour, minutes: selected.minute)
//       : (min != null
//           ? Duration(hours: min.hour, minutes: min.minute)
//           : Duration(hours: now.hour, minutes: now.minute));
//   if (setMinuteInterval != null) {
//     duration = Duration(
//       hours: duration.inHours,
//       minutes: _convertMinute(duration.inHours, duration.inMinutes) %
//                   setMinuteInterval ==
//               0
//           ? 0
//           : _convertMinute(duration.inHours, duration.inMinutes) -
//               _convertMinute(duration.inHours, duration.inMinutes) %
//                   setMinuteInterval +
//               setMinuteInterval,
//     );
...
//                       minuteInterval: setMinuteInterval ?? 1,
